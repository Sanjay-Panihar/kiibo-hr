<div class="modal fade" id="attendenceRegularisation" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="attendenceRegularisationLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <span><strong>Reporting Manager (ECode):</strong> <span id="reporting_manager">Jai Ram Chaudhary (AGL2795)</span></span>
                    </div>
                    <div class="col-md-6">
                ...
                <form id="leaveForm">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="time" class="form-control" id="punch_in" name="punch_in" onchange="calculateWorkingHours()">
                            <small class="text-muted" id="punch_in_time">HH:MM (24:00 Format)</small>
                            <span class="text-danger" id="punch_in_error"></span>
                        </div>
                        <div class="col-md-6">
                            <label for="punch_out" class="form-label">Out Time <span class="text-danger">*</span></label>
                            <input type="time" class="form-control" id="punch_out" name="punch_out" onchange="calculateWorkingHours()">
