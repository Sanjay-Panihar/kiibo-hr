                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form action="{{ route('admin.employee-report.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('emp_code') is-invalid @enderror" id="emp_code" name="emp_code" value="{{ old('emp_code') }}" required>
                                    @error('emp_code')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('notice_period') is-invalid @enderror" id="notice_period" name="notice_period" value="{{ old('notice_period') }}" required>
                                    @error('notice_period')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('entity') is-invalid @enderror" id="entity" name="entity" value="{{ old('entity') }}" required>
                                    @error('entity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('reporting_manager') is-invalid @enderror" id="reporting_manager" name="reporting_manager" value="{{ old('reporting_manager') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('department_head') is-invalid @enderror" id="department_head" name="department_head" value="{{ old('department_head') }}" required>
