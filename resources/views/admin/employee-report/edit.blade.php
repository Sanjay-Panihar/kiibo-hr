                            ...
                            <form action="{{ route('admin.employee-report.update', $employeeReport->id) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="gender" id="gender"
                                        ...
                                        <option value="1" {{ old('gender', $employeeReport->gender) == '1' ? 'selected' : '' }}>Male</option>
                                        <option value="2" {{ old('gender', $employeeReport->gender) == '2' ? 'selected' : ''}}> Female</option>
                                        <option value="3" {{ old('Other', $employeeReport->gender) == '3' ? 'selected' : ''}}> Other</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="marital_status" id="marital_status"
                                        ...
                                        <option value="1" {{ old('marital_status', $employeeReport->marital_status) == '1' ? 'selected' : '' }}>Married
                                        </option>
                                        <option value="0" {{ old('marital_status', $employeeReport->marital_status) == '0' ? 'selected' : '' }}>Unmarried
                                        </option>
                                        @error('image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="salutation" id="salutation"
                                    ...
                                    <option value="Mr." {{ old('salutation', $employeeReport->salutation) == 'Mr.' ? 'selected' : '' }}>Mr.</option>
                                    <option value="Mrs." {{ old('salutation', $employeeReport->salutation) == 'Mrs.' ? 'selected' : '' }}>Mrs.</option>
                                    <option value="Miss." {{ old('salutation', $employeeReport->salutation) == 'Miss.' ? 'selected' : '' }}>Miss.
                                    </option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="designation" id="designation" class="form-select @error('designation') is-invalid @enderror">
                                        ...
                                        @foreach ($designations as $designation)
                                            <option value="{{ $designation->id }}" {{ old('designation', $employeeReport->designation) == $designation->id ? 'selected' : '' }}>{{ $designation->name }}</option>
                                        @endforeach
                                    </select>
                                @error('designation')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('reporting_manager') is-invalid @enderror"
                                    ...
                                    value="{{ old('reporting_manager', $employeeReport->reporting_manager) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('blood_group') is-invalid @enderror" id="blood_group"
                                    ...
                                    <option value="A+" {{ old('blood_group', $employeeReport->blood_group) == 'A+' ? 'selected' : '' }}>A+</option>
                                    <option value="A-" {{ old('blood_group', $employeeReport->blood_group) == 'A-' ? 'selected' : '' }}>A-</option>
                                </select>
                                @error('blood_group')
                                    <div class="invalid-feedback">{{ $message }}</div>
